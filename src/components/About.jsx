...
const About = () => {
  return (
    <div>
      {/* about text */}
      <div className="px-4 lg:px-14 max-w-screen-2xl w-full mx-auto my-8 ">
      ...
      <div className="px-4 lg:px-14 mx-auto bg-neutralSilver py-16 flex max-w-screen-2xl w-full">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutralGrey">Event Bookings</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutralGrey">Payments</p>
              </div>
            </div>
          </div>
        </div>
